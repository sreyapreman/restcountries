...
function displayCountries(countries){
  ...
  <div class="card-body">
    ...
    <p class="card-text">BORDERS: ${c.population}</p>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item">CAPITAL: ${c.capital??"no capitals"}</li>
    <li class="list-group-item">NATIVENAME: ${c.nativeName}</li>
    <li class="list-group-item">REGION: ${c.region}</li>
  </ul>
  <div class="card-body">
  ...
  function displayRegions(regions){
    ...
    for(let reg of regions){
      data+=`
      <div>
      <button class="btn btn-outline-info"  onclick="filterRegions('${reg}')" value="${reg}">${reg}</button>
      </div>
      `
    }
  ...
  // appending value to the select box
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item">CAPITAL: ${data.capital??"no capital"}</li>
    <li class="list-group-item">NATIVENAME: ${data.nativeName}</li>
